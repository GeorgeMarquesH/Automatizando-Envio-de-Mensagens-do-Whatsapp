# Automatizando o Envio de Mensagens do WhatsApp
...
* `automacao_whatsapp.ipynb`: Arquivo com o código em Python dividido em células de execução.
* `Envios.xlsx`: Tabela do Excel que contém o nome dos contatos, as mensagens, os números de telefone e os nomes dos arquivos para envio.
* `arquivos/`: Pasta destinada a guardar as fotos ou documentos que são enviados como anexo nas mensagens.
